...
public class SLList<Blorp> implements List61B<Blorp> {
	...
	public SLList(Blorp x) {
	  ...
	  */
     @Override // this is not required, but it's a good idea
    ...
    /* I don't trust the yahoo who wrote the garbage print method. I'm going to use
       my own very cool knowledge to avoid shuttle sprints.
     */
    @Override
    public void print() {
        Node p = sentinel;
